...
import styles from "../style/topboxcarusels.module.scss";
...
const array: Props[] = [
  {
    text: " Valencia Basket-Real Madrid: tough EuroLeague away day on the horizon ",
    img: "https://assets.realmadrid.com/is/image/realmadrid/ND-EUROLEAGUE-RM-FENERBAHCE-MALEDON-ABALDE_SG11256?$Desktop$&fit=wrap&wid=350",
  },
  {
    text: " Courtois medical report  ",
    img: "https://assets.realmadrid.com/is/image/realmadrid/ND-LIGA-J12-RAYO-RM-COURTOIS_1PC4923?$Desktop$&fit=wrap&wid=350",
  },
  {
    text: " Valverde medical report  ",
    img: "https://assets.realmadrid.com/is/image/realmadrid/ND-LIGA-J12-RAYO-RM-VALVERDE_MJ16688?$Desktop$&fit=wrap&wid=350",
  },
  {
    text: ` Scariolo: "The victories show we're on the right track" `,
    img: "https://assets.realmadrid.com/is/image/realmadrid/ND-DECLARACIONES-SCARIOLO_SG23683_1?$Desktop$&fit=wrap&wid=350",
  },
];

const TopBoxCarusels = () => {
  ...
  const handleMove = (e: any) => {
    ...
    // Prevent dragging if maxIndex is 0
  ...
  const handleEnd = () => {
    ...
    // Don't update position if maxIndex is 0
    if (maxIndex === 0) {
